    ...
    <div class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <a class="btn btn-success tooltips" href="<?php echo base_url('admin/properties/add'); ?>" title="<?php echo lang('properties tooltip add_new_porperty') ?>" data-toggle="tooltip"><span class="glyphicon glyphicon-plus-sign"></span> <?php echo lang('properties button add_new_property'); ?></a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-striped table-hover-warning">
        <thead>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo current_url(); ?>?sort=is_admin&dir=<?php echo (($dir == 'asc' ) ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('properties col is_admin'); ?></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p><?php echo sprintf(lang('properties msg delete_confirm'), $property['type'] . " " . $property['last_name']); ?></p>
                    </div>
